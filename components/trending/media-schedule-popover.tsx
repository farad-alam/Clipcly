...
interface MediaSchedulePopoverProps {
    mediaUrl: string
    meta: {
        title: string;
        author: string;
        duration?: number; // Optional for images
        mediaType: 'IMAGE' | 'VIDEO';
    }
}

export function MediaSchedulePopover({ mediaUrl, meta }: MediaSchedulePopoverProps) {
    ...
    const handleSchedule = async () => {
        ...
        const res = await scheduleVideo({
            videoUrl: mediaUrl, // We keep the param name 'videoUrl' for compatibility or rename key in usage
            scheduledAt,
            title: meta.title,
            author: meta.author,
